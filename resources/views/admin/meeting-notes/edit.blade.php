...
<head>
    ...
    <title>Edit Meeting Note - ConnecTIK Admin</title>
    ...
    <div class="container-fluid mt-4 mb-5">
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                ...
                <p class="text-muted">Ubah notulensi rapat #{{ $meetingNote->document_no }}</p>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.meeting-notes.update', $meetingNote->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="document_no" 
                                       name="document_no" 
                                       value="{{ old('document_no', $meetingNote->document_no) }}" 
                                       required>
                                @error('document_no')
                        ...
                        <div class="col-md-9">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="project_name" 
                                       name="project_name" 
                                       value="{{ old('project_name', $meetingNote->project_name) }}" 
                                       required>
                                @error('project_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="date" 
                                       ...
                                       id="meeting_date" 
                                       name="meeting_date" 
                                       value="{{ old('meeting_date', $meetingNote->meeting_date->format('Y-m-d')) }}" 
                                       required>
                                @error('meeting_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="meeting_time" 
                                       name="meeting_time" 
                                       value="{{ old('meeting_time', $meetingNote->meeting_time) }}" 
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('meeting_location', $meetingNote->meeting_location) }}" 
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('type_of_meeting') is-invalid @enderror" 
                                    ...
                                    <option value="Discussion" {{ old('type_of_meeting', $meetingNote->type_of_meeting) == 'Discussion' ? 'selected' : '' }}>Discussion</option>
                                    <option value="Review" {{ old('type_of_meeting', $meetingNote->type_of_meeting) == 'Review' ? 'selected' : '' }}>Review</option>
                                    <option value="Planning" {{ old('type_of_meeting', $meetingNote->type_of_meeting) == 'Planning' ? 'selected' : '' }}>Planning</option>
                                    <option value="Coordination" {{ old('type_of_meeting', $meetingNote->type_of_meeting) == 'Coordination' ? 'selected' : '' }}>Coordination</option>
                                    <option value="Evaluation" {{ old('type_of_meeting', $meetingNote->type_of_meeting) == 'Evaluation' ? 'selected' : '' }}>Evaluation</option>
                                </select>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('meeting_called_by', $meetingNote->meeting_called_by) }}" 
                                       required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" 
                                       ...
                                       id="note_taker" 
                                       name="note_taker" 
                                       value="{{ old('note_taker', $meetingNote->note_taker) }}" 
                                       required>
                                @error('note_taker')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('attendance') is-invalid @enderror" 
                                ...
                                required>
                            @php
                                $selectedAttendance = old('attendance', 
                                    array_map('trim', explode(',', $meetingNote->attendance))
                                );
                            @endphp
                            @foreach($anggotas as $anggota)
                                <option value="{{ $anggota->nama }}" 
                                    {{ in_array($anggota->nama, $selectedAttendance) ? 'selected' : '' }}>
                                    {{ $anggota->nama }} ({{ $anggota->jabatan }})
                                </option>
                            @endforeach
                            {{-- Pre-select existing attendance yang tidak ada di list anggota --}}
                            @foreach($selectedAttendance as $attendee)
                                @if(!$anggotas->contains('nama', $attendee) && !empty($attendee))
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               id="topic" 
                               name="topic" 
                               value="{{ old('topic', $meetingNote->topic) }}" 
                               required>
                        @error('topic')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="section-divider">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control summernote @error('meeting_result') is-invalid @enderror" 
                                      id="meeting_result" 
                                      name="meeting_result" 
                                      rows="5">{{ old('meeting_result', $meetingNote->meeting_result) }}</textarea>
                    ...
                    <div class="section-divider">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control summernote @error('on_progress') is-invalid @enderror" 
                                      id="on_progress" 
                                      name="on_progress" 
                                      rows="5">{{ old('on_progress', $meetingNote->on_progress) }}</textarea>
                            @error('on_progress')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="section-divider">
                        ...
                        <div class="mb-3">
                            <textarea class="form-control summernote @error('akan_dilakukan') is-invalid @enderror" 
                                      id="akan_dilakukan" 
                                      name="akan_dilakukan" 
                                      rows="5">{{ old('akan_dilakukan', $meetingNote->akan_dilakukan) }}</textarea>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary btn-lg">
                            <i class="fas fa-save me-2"></i>Update Meeting Note
                        </button>
