...
<head>
    ...
    <title>Edit Sertifikat - ConnecTIK</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('anggota.sertifikat.update', $sertifikat->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('riwayat_kegiatan_id') is-invalid @enderror" 
                                    ...
                                    <option value="{{ $sertifikat->riwayat_kegiatan_id }}" selected>
                                        {{ $sertifikat->riwayatKegiatan->judul }}
                                    </option>
                                </select>
                            ...
                            <div id="kegiatan_info" class="alert alert-info mb-3">
                                ...
                                <div id="kegiatan_details">
                                    <p class="mb-1"><strong>Judul:</strong> {{ $sertifikat->riwayatKegiatan->judul }}</p>
                                    <p class="mb-1"><strong>Tanggal:</strong> {{ $sertifikat->riwayatKegiatan->tanggal_kegiatan_formatted }}</p>
                                    <p class="mb-1"><strong>Jenis:</strong> {{ $sertifikat->riwayatKegiatan->jenis_kegiatan }}</p>
                                    <p class="mb-0"><strong>Penyelenggara:</strong> {{ $sertifikat->riwayatKegiatan->penyelenggara }}</p>
                                </div>
                            </div>
                                    ...
                                    <div class="mb-2">
                                        <a href="{{ route('anggota.sertifikat.download', $sertifikat->id) }}" 
                                           class="btn btn-sm btn-outline-primary">
                                            <i class="fas fa-download me-1"></i>Lihat File Saat Ini
                                        </a>
                                    </div>
                                @endif
                                <input type="file" 
